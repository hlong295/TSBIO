...
// NOTE: We keep role strings flexible because DB can evolve.
// "admin" is kept for backward-compat with earlier deployments.
export type AdminRole = "root_admin" | "admin" | "editor" | "provider" | "approval";
