...
const url = (typeof process.env.NEXT_PUBLIC_SUPABASE_URL || runtimeEnv?.supabaseUrl==="string"?process.env.NEXT_PUBLIC_SUPABASE_URL || runtimeEnv?.supabaseUrl.trim():String(process.env.NEXT_PUBLIC_SUPABASE_URL || runtimeEnv?.supabaseUrl??""));
const anonKey = (typeof process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || runtimeEnv?.supabaseAnonKey==="string"?process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || runtimeEnv?.supabaseAnonKey.trim():String(process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || runtimeEnv?.supabaseAnonKey??""));
