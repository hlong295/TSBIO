...
## State:
- Baseline code input: TSBIO_BASELINED_SRC_2026_02_07_v4.zip
...
## Now:
- Zip source baseline v4 for user download.

## Next:
- Apply DB stageA SQL on Supabase (A1.2, A2.1) and re-snapshot schema/functions in a real DB export.
