...
## Now:
- Verify on Vercel/Pi App Studio: login `hlong295` → /admin → wait 2–5 min → click tabs; should NOT get stuck on “Đang kiểm tra phiên Admin...” and should keep Admin usable.
