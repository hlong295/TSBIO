...
## State:
- Current baseline source: **TSBIO_SRC_20260207_v23.zip**
- Phase B taxonomy choice: **Hub + Product + News + Rescue** (4 tables)
- DB migration to apply (safe repair): `baselines/database/TSBIO_DB_20260207_v23_phaseB_taxonomy_cms_SAFE.sql`
