...
- Working branch output (this change): **v28_fix21 (Phase B1 C3 Media: 1 video + 10 images, API-guarded)**.
...
## Now:
- (Waiting user test) Admin Product Media in Edit page: upload/remove images & video, enforce limits, store metadata in `products.media`.
