...
- Working branch output (this change): **v29_fix22 (C3 Media UX: create product can pick media immediately + media library attach)**.
...
## Now:
- Fix requested: In Admin /products/new, allow pick media immediately (device upload or choose from Media Library), without forcing user to create then edit.
