...
## Now:
- Verify B1 on user env: upload images/videos on `/admin/products/new` shows pending/progress rows + previews; "Chọn từ thư viện" opens picker and selected items appear; Save should commit into `products.media`.
