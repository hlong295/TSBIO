...
Current Source: TSBIO_SRC_20260209_v35_MEDIA_realtime_upload_progress_fix28.zip
Current DB: TSBIO_DB_2026_02_07_v4.sql (+ Phase B taxonomy/cms migration v23B SAFE + PhaseB1 flags migration v27; + v34 media bucket script)
...
## Current Baseline — v35_fix28 (2026-02-09)

- Phase: A in progress (Auth core hardening done; remaining A1/A2 edgecases to validate)
- DB: (unchanged; use latest DB snapshot on your project)
- Source: TSBIO_SRC_20260209_v35_MEDIA_realtime_upload_progress_fix28.zip
...
### B1 (V27) — Product Flags + WYSIWYG (Step C1/C2)
- Admin Product form now supports constitution flags: is_combo, is_featured, is_flashsale, is_verified, is_archived.
- WYSIWYG editor (Tiptap) replaces textarea; server sanitizes HTML on create/update.
- DB add script (safe): `baselines/database/TSBIO_DB_20260208_v27_phaseB1_products_flags_wysiwyg.sql`.
...
- /admin/media (signed upload + list) uses Supabase Storage bucket "media".
  - v34: server routes auto-ensure bucket exists (best-effort) to avoid "no buckets" state.
  - DB script: baselines/database/TSBIO_DB_20260209_v34_media_storage_bucket.sql
