...
// Avoid build-time prerender crashes on environments that attempt to pre-render
// client-only auth flows. This page depends on browser session/hash params.
...
export default function CapNhatMatKhauPage() {
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      <main className="px-4 pt-header pb-4 space-y-4 max-w-screen-sm mx-auto">
