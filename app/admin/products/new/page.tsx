...
// This can crash builds/runtime in App Router export mode.
          ...
          <Button
            ...
            onClick={async () => {
              ...
              try {
                ...
                if (id) {
                  if ((mediaDraft.pendingUploads?.length || 0) > 0) {
                    ...
                    try {
                      ...
                      for (const url of mediaDraft.libraryVideos || []) {
                        if (url) items.push({ kind: "video", url, name: url });
                      }
