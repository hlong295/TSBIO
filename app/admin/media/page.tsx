...
export default function AdminMediaPage() {
  ...
  function normalizePrefixValue(raw: unknown) {
    // Guard: sometimes a click event is accidentally passed into refresh/load.
    // Only accept string input here.
  ...
  const load = async (overridePrefix?: unknown) => {
