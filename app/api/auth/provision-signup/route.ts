...
export async function POST(req: Request) {
  try {
    ...
    const userId = (typeof body.userId==="string"?body.userId.trim():String(body.userId??""));
    const email = (typeof body.email==="string"?body.email.trim():String(body.email??"")).toLowerCase();
    const username = (typeof body.username==="string"?body.username.trim():String(body.username??"")).toLowerCase();
